...
set LAUNCHER_MAX_METASPACE_SIZE_OPTION=-XX:MaxMetaspaceSize=15m

set MIN_REQUIRED_JAVA_VERSION=1.7
set ADDITIONAL_FIND_JAVA_DIRS="..\..\internal\java\windows-x86"
